...
export const pageIndex = [
    {
        name: 'Input',
        pages: [
            {link: '/container/input', title: 'Input'}
        ]
    },
    {
        name: 'Result',
        pages: [
            {link: '/container/result', title: 'Result'}
        ]
    },
]
...
export const howToUseDummyData = [
    ...
    {content1: 'If you want to use the noise control function, please select function and step of each model.'},
    {content1: 'Edit field conditions based on the installation site.'},
    {content1: 'Check the preview image to make sure the environment information you entered is correct.'},
    {
        content1: 'If you want to export the result, click the button “Export as PDF” on the ‘Report’ sheet',
