...
export default function Overview() {
    return (
        ...
        <div
            ...
            <div className='text-[2.5rem] text-gray_900 font-LGSMHATB static z-[1] mobile:text-[2rem]'>LATS Noise</div>
            <Image src={IC_MAIN} alt={'overview'} className='absolute right-[22.813rem] mobile:right-[-3.125rem]'/>
        </div>
    )
}