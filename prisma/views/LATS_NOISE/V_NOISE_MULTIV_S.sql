...
FROM
  (
    ...
    JOIN (
      ...
      WHERE
        `LATS_CMN`.`T_MASTER_MV_ODU`.`DESCRIPTION` = 'MULTI V S R32'
      ...
      FROM
        `LATS_CMN`.`T_MASTER_MV_ODU`
      WHERE
        `LATS_CMN`.`T_MASTER_MV_ODU`.`DESCRIPTION` = 'MULTI V S'
        AND `LATS_CMN`.`T_MASTER_MV_ODU`.`LOCATION` LIKE '%/7/%'
        AND (
          `LATS_CMN`.`T_MASTER_MV_ODU`.`NOTUSEDCOUNTRY` NOT LIKE '%/7/%'
          OR `LATS_CMN`.`T_MASTER_MV_ODU`.`NOTUSEDCOUNTRY` IS NULL
        ...
        AND `LATS_CMN`.`T_MASTER_MV_ODU`.`VISIBLE` = 1
        AND `LATS_CMN`.`T_MASTER_MV_ODU`.`SYSTEM_CHECK_CODE` = 223
      UNION
      ALL
      SELECT
        `LATS_CMN`.`T_MASTER_MV_ODU`.`BUYER_MODEL_NAME` AS `BUYER_MODEL_NAME`,
      ...
      FROM
        `LATS_CMN`.`T_MASTER_MV_ODU`
      WHERE
        `LATS_CMN`.`T_MASTER_MV_ODU`.`DESCRIPTION` = 'MULTI V S(Compact)'
        AND `LATS_CMN`.`T_MASTER_MV_ODU`.`LOCATION` LIKE '%/7/%'
        AND (
          `LATS_CMN`.`T_MASTER_MV_ODU`.`NOTUSEDCOUNTRY` NOT LIKE '%/7/%'
          OR `LATS_CMN`.`T_MASTER_MV_ODU`.`NOTUSEDCOUNTRY` IS NULL
      ...
      FROM
        `LATS_CMN`.`T_MASTER_MV_ODU`
      WHERE
        `LATS_CMN`.`T_MASTER_MV_ODU`.`DESCRIPTION` = 'MULTI V S HR'
        AND `LATS_CMN`.`T_MASTER_MV_ODU`.`LOCATION` LIKE '%/7/%'
        AND (
          `LATS_CMN`.`T_MASTER_MV_ODU`.`NOTUSEDCOUNTRY` NOT LIKE '%/7/%'
          OR `LATS_CMN`.`T_MASTER_MV_ODU`.`NOTUSEDCOUNTRY` IS NULL
